 ...
 *
 * Example:
 * [_object, [0,0,0]] call reapercrew_reinforcements_fnc_spawnHeadlessAircraft
 *
 * Public: No
 */
...
[_targetObject,_spawnPoint, _selection] spawn {
	...
	switch (_selection) do {
		case 0: {
			_randomVehicleClass = selectRandom (enemyFireSupportLightRotary + enemyFireSupportHeavyRotary + enemyFireSupportFixedWing);
		};
		case 1: {
			_randomVehicleClass = selectRandom enemyFireSupportLightRotary;
		};
		case 2: {
			_randomVehicleClass = selectRandom enemyFireSupportHeavyRotary;
		};
		case 3: {
			_randomVehicleClass = selectRandom enemyFireSupportFixedWing;
		};
		default {
			_randomVehicleClass = selectRandom (enemyFireSupportLightRotary + enemyFireSupportHeavyRotary + enemyFireSupportFixedWing);
		};
