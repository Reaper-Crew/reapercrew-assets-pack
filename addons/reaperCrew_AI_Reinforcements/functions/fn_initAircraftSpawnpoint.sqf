...
if (!isServer) exitWith {diag_log "SCENARIO: Server checked failed - Not initialising init for Aircraft spawns"};
...
diag_log "SCENARIO: Initialising Aircraft spawnpoint module";
