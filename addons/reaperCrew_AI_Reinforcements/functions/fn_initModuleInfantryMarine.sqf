/*
 * Author: Xeenenta
 * This function is run during the init phase of the Marine reinforcements module and should setup the necessary triggers in order to start the reinforcements process.
 *
 * Arguments:
 * 0: Object <OBJECT> 
 *
 ...
 *
 * Example:
 * [_logic] call reapercrew_reinforcements_fnc_initModuleInfantryMarine
 *
 * Public: No
 */
...
_activationTrigger setTriggerStatements ["(this && {isTouchingGround _x} count thisList > 0)", "[thisTrigger] spawn reapercrew_reinforcements_fnc_activateInfantryModuleMarine;", "diag_log '[REINFORCEMENTS]: The trigger has been deactivated'"];
