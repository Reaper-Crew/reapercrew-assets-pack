...
_activationTrigger setTriggerStatements [_triggerCondition, "[thisTrigger] spawn reapercrew_reinforcements_fnc_activateInfantryModuleAirbourne;", "diag_log '[REINFORCEMENTS]: The trigger has been deactivated'"];
