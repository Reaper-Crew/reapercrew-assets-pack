...
["reaperCrew_pauseInfantryReinforcements", "CHECKBOX", ["Pause Infantry Reinforcements", "Tick to pause infantry reinforcements"], ["Reaper Crew - AI Reinforcements", "Live Mission Settings"]] call cba_settings_fnc_init;
