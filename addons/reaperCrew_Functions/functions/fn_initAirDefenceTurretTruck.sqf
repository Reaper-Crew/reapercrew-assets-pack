...
diag_log "Creating Phalanx truck";
...
_createdTurret = [(_attachVehicle getRelPos [5, 90]), _vehicleDirection, "B_AAA_System_01_F", west] call BIS_fnc_spawnVehicle;
...
_vehicleObject attachTo [_attachVehicle, [0, -0.5, 1.7]]; 
